...
BUILDFILE = 'https://raw.githubusercontent.com/tvbanteam/repositorio.tvbandteam/master/buildtvban/buildstvban.txt'
...
ADVANCEDFILE = 'https://raw.githubusercontent.com/tvbanteam/tvbanteam.github.io/master/andtvban/wizard/Advanced.json'
#########################################################
...
# Font size of header
FONTHEADER = ''
HEADERMESSAGE = '[COLOR azure][B]TVBAN[/B][/COLOR] [COLOR dodgerblue][B]OMEGA[/B][/COLOR]'
